...
ckpt = "Checkpoint2/sac_qsacActor_Test2_ep12000.pth"
# arch = "classical"  # choose: qactor_classic_critic, full_quantum, classical
# ckpt = "1sac_actor_model.pth"
# arch = "classical"
...
def build_qsac_agent(arch: str, state_dim: int, action_dim: float, max_action: float, device: torch.device):
    ...
    if arch in {"qactor_classic_critic", "quantum_actor_classic_critic", "qa_cc"}:
        from SAC_QonlyCritic_Test_ver2 import SACAgent as QSACAgent
