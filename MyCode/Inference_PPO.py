...
import pandas as pd
from _PPO import PPOAgent  # ensure import path is correct
...
agent.actor.load_state_dict(torch.load("Model/ppo_actor_model.pth", map_location=device))
agent.actor.eval()
...
plt.tight_layout()
plt.savefig("ppo_metrics_4panel.png")
plt.show()
