...
class ReUploadingVQC(nn.Module):
    def __init__(self, n_qubits: int, qnn_layers: int, device_name: str = "default.qubit.torch"):
        super().__init__()
...
class QuantumActor(nn.Module):
    def __init__(self, state_dim: int, action_dim: int, max_action: float,
                 n_qubits: int = 8, qnn_layers: int = 2, device_name: str = "default.qubit.torch"):
        super().__init__()
...
class SACAgent:
    def __init__(self, state_dim, action_dim, max_action, device,
                 n_qubits: int = 8, qnn_layers: int = 2, q_device_name: str = "default.qubit.torch",
