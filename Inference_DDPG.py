...
import pandas as pd
from _DDPG import DDPGAgent  # ensure import path is correct
...
agent.actor.load_state_dict(torch.load("Model/ddpg_actor_model.pth", map_location=device))
agent.actor.eval()
...
plt.tight_layout()
plt.savefig("DDPG_metrics_4panel.png")
plt.show()
